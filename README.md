...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cluster_tools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14520&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cluster_tools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cluster_tools` can be installed with:

```
conda install cluster_tools
```

It is possible to list all of the versions of `cluster_tools` available on your platform with:
